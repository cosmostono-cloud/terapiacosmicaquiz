...
import { Headphones, Play, Sparkles, Lock, Lightbulb, Leaf } from "lucide-react";
...
const ResultsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-white p-6 flex flex-col items-center overflow-x-hidden relative">
      ...
      {/* Card de Experiência Imersiva (Estilo Imagem 2) */}
        ...
        <Card className="glass-card border-white/5 overflow-hidden relative z-10">
          <CardContent className="p-0">
            <div className="p-8 flex flex-col items-center text-center">
              ...
              {/* Avatar Central com Glow */}
              <div className="relative mb-16">
                <div className="absolute inset-0 bg-primary/30 blur-3xl rounded-full animate-pulse"></div>
                <div className="w-48 h-48 rounded-full border-4 border-primary/40 p-1 relative z-10">
                  <img 
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <button className="w-24 h-24 rounded-full bg-white flex items-center justify-center text-black hover:scale-110 transition-transform shadow-[0_0_40px_rgba(255,255,255,0.3)] group">
      ...
      <div className="mt-24 max-w-2xl text-center space-y-8 pb-20">
        ...
        <a href="https://terapiacosmica.tonocosmos.com.br/" target="_blank" rel="noopener noreferrer" className="block pt-8">
          <Button size="lg" className="h-16 px-12 text-xl font-black bg-primary text-white rounded-full glow-primary hover:scale-105 transition-all">
