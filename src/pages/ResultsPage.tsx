...
const ResultsPage = () => {
  ...
  if (score >= 81) {
    ...
    resultDescription = `Olá ${userName}, com base nas suas respostas, percebo que você está num momento de transição interna e precisa de clareza, equilíbrio e liberação energética. Há padrões e emoções antigas que estão te impedindo de avançar. A Terapia Holística vai te ajudar a destravar esses bloqueios e realinhar sua energia para que você viva com mais leveza e direção.`;
    ...
    resultDescription = `Olá ${userName}, suas respostas indicam que você está em um processo de despertar, buscando maior autoconhecimento e equilíbrio. Você já percebe a necessidade de mudança e está aberta a novas perspectivas. A Terapia Holística pode acelerar sua jornada, oferecendo ferramentas para limpar o que não serve mais e fortalecer sua conexão interior.`;
